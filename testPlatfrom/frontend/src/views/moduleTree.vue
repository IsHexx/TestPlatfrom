  ...
  <div class="module-tree">
    ...
    <div class="tree-body">
      <el-tree class="filter-tree" :accordion="true" :data="treeData" :current-node-key="currentModule"
               ...
               :props="defaultProps" node-key="id" :expand-on-click-node="true" :filter-node-method="filterNode"
                      ...
                      <span class="custom-tree-node" slot-scope="{ node, data }">
                          ...
                          <span class="tree-opt">
                              <el-button size="mini" type="text" icon="el-icon-plus"
                                         @click="() => appendModule(data)"></el-button>
                              <el-button size="mini" type="text" icon="el-icon-delete"
                                         @click="() => removeModule(node, data)"></el-button>
                          </span>
                      </span>
      </el-tree>
    </div>
