      ...
      <div class="login_content">
        <div class="login_bac ">
          <div class="login_content1 ">
            ...
            <input type="text" placeholder="请输入账号" class="register_content_input" v-model= "LUserPhone" @blur="checkLPhone"><br>
            <span class="tishixiaoxi disappear">请输入账号</span>
    ...
    methods:{
      ...
      checkLPhone(){
          if(this.LUserPhone == ''){
              ...
              $(".login_content1 span:eq(0)").text("请输入账号")
          ...
          //     return true;
          }else if(this.LUserPhone.search(/[a-z]/)==0){
              $(".login_content1 span:eq(0)").addClass("disappear")
              return true;
          }else{
              $(".login_content1 span:eq(0)").removeClass("disappear");
              $(".login_content1 span:eq(0)").text("请输入小写字母。")
          }
      },
      //验证登陆密码格式
      checkLPsd(){
...
.login_or_register{
  background: url("/static/img/backs.jpg");
...
.logo1{
    text-align: center;
    padding:40px 0 50px ;   margin:0 auto;
}
/*login和register部分*/
.login_bac{
    width:1180px;
...
.send_message{
    ...
    padding-left: 45px;
    padding-right: 5px;
    background: url('/static/img/suo.png') no-repeat 10px 8px;
